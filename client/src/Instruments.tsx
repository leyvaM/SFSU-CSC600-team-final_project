...
export interface mpcInstrumentProps {
  state: AppState;
  dispatch: React.Dispatch<DispatchAction>;
  name: string;
...
export class mpcInstrument {
  public readonly name: string;
  public readonly component: React.FC<mpcInstrumentProps>;

  constructor(name: string, component: React.FC<mpcInstrumentProps>) {
    this.name = name;
    this.component = component;
  }
}
